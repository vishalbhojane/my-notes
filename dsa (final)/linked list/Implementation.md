...
##### Removing an item from the tail end of a Linked List is:
O(n)
...
O(n)
This is a place where Linked Lists are better than Arrays. Arrays are O(n) when removing the first item because of the re-indexing that is required.
